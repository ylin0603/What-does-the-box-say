...
public class Collision {
    final double PlayerSize = Cdc.BOX_SIZE / 2;

    // for normal player collision
    // for normal attack
    public boolean isPlayersCollison(ClientPlayerFeature player1,
    ...
    public boolean isItemPlayerCollison(ClientItemFeature item,
            ClientPlayerFeature player2) {
        double size = ((PlayerSize * 2) * 1.2);
    ...
    public boolean isItemItemCollison(ClientItemFeature item1,
    ...
    // for eat pack
    // for bullet attack
    public boolean isCirclePlayerCollison(int c1LocX, int c1LocY, int c1Size,
            ClientPlayerFeature player2) {
